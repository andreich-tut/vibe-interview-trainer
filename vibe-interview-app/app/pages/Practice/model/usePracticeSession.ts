...
import { type Score, type Card } from "~/pages/Practice/ui/FlashCard";
import { useProgress } from "~/pages/Home/model/useProgress";
import { hasApiKey } from "~/lib/llm";
import { useCardDeck, type CardScore } from "./useCardDeck";
